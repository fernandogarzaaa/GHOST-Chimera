...
COMPETITIVE_CAPABILITIES: tuple[CompetitiveCapability, ...] = (
    ...
    CompetitiveCapability(
        ...
        benchmark="Codex and Claude-style issue-to-PR engineering with local worktree execution and CI repair loops.",
    ...
    CompetitiveCapability(
        ...
        benchmark="Agent platforms that adapt onboarding, tools, memory, and automations to a user role.",
