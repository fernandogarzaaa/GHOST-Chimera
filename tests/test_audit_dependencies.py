...
from scripts.audit_dependencies import (  # noqa: E402
...
class TestDependencyAudit:
    ...
    def test_audit_empty_dependencies(self):
        ...
        pyproject_data = {"project": {"name": "test-project", "dependencies": []}}
    ...
    def test_audit_base_dependencies(self):
        ...
        pyproject_data = {
            "project": {
                "name": "test-project",
                "dependencies": ["package1==1.0.0", "package2>=2.0.0", "package3>=3.0.0,<4.0.0"],
            }
        }
    ...
    def test_audit_optional_dependencies(self):
        ...
        pyproject_data = {
            "project": {
                "name": "test-project",
                "dependencies": [],
                "optional-dependencies": {"dev": ["pytest>=7.0.0"], "docs": ["sphinx==4.0.0"]},
            }
        }
    ...
    def test_audit_common_risks(self):
        ...
        pyproject_data = {
            "project": {
                "name": "test-project",
                "dependencies": ["package1>=1.0.0", "package2>=2.0.0", "package3>=3.0.0"],
            }
        }
...
class TestAuditFormatting:
    ...
    def test_format_text_with_risks(self):
        ...
        results = {
            "base_dependencies": [
                {"spec": "package>=1.0.0", "risks": ["Unpinned upper bound"], "notes": ["Consider adding upper bound"]}
            ],
            "optional_extras": {},
            "dev_dependencies": [],
            "risk_summary": {
                ...
                "common_risks": [{"risk": "Unpinned upper bound", "count": 1}],
            },
        }
    ...
    def test_format_markdown(self):
        ...
        results = {
            "base_dependencies": [{"spec": "package==1.0.0", "risks": [], "notes": []}],
            "optional_extras": {},
            "dev_dependencies": [],
            "risk_summary": {"total_dependencies": 1, "dependencies_with_risks": 0, "common_risks": []},
        }
...
class TestAuditIntegration:
    ...
    def test_audit_complete_pyproject(self):
        ...
        try:
            ...
            assert (
                "missing_expected_extras" not in result["risk_summary"]
                or len(result["risk_summary"]["missing_expected_extras"]) == 0
            )
        finally:
            temp_path.unlink()
