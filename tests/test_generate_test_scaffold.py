...
from scripts.generate_test_scaffold import (  # noqa: E402
    analyze_source_file,
...
class TestScaffoldGeneration:
    ...
    def test_generate_scaffold_for_functions(self):
        ...
        analysis = {"functions": [{"name": "test_func", "args": ["arg1"], "lineno": 1}], "classes": [], "imports": []}
    ...
    def test_generated_scaffold_is_valid_python(self):
        ...
        analysis = {
            "functions": [{"name": "func1", "args": [], "lineno": 1}],
            "classes": [{"name": "Class1", "methods": [{"name": "method1", "args": [], "lineno": 2}], "lineno": 1}],
            "imports": [],
        }
        source_path = Path("test_module.py")
    ...
    def test_generate_scaffold_uses_project_module_for_relative_project_source(self):
        ...
        analysis = {
            "functions": [],
            "classes": [{"name": "GhostChimeraConfig", "methods": [], "lineno": 1}],
            "imports": [],
        }
...
class TestCLIBehavior:
    ...
    def test_output_file_is_written(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                old_argv = sys.argv
                sys.argv = ["generate_test_scaffold.py", "--source", str(source_path), "--output", str(output_path)]
    ...
    def test_missing_source_returns_error(self):
        ...
        old_argv = sys.argv
        sys.argv = ["generate_test_scaffold.py", "--source", "/nonexistent/file.py", "--output", "/tmp/output.py"]
