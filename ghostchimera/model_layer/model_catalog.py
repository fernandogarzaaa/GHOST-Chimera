...
_CATALOG: list[ModelCatalogEntry] = [
    ...
    # ── 2026 flagships (context/pricing from models.dev + OpenRouter, Sep 2026) ──
    ModelCatalogEntry(
        provider="openai",
        model_id="gpt-5.2",
        display_name="GPT-5.2",
        context_window_tokens=400_000,
        input_cost_usd_per_1k=0.00175,
        output_cost_usd_per_1k=0.014,
        supports_streaming=True,
        supports_vision=True,
    ),
    ModelCatalogEntry(
        ...
        input_cost_usd_per_1k=0.03,
        output_cost_usd_per_1k=0.18,
        supports_streaming=True,
        supports_vision=True,
    ),
    ModelCatalogEntry(
    ...
    ModelCatalogEntry(
        ...
        context_window_tokens=1_000_000,
        input_cost_usd_per_1k=0.000435,
        output_cost_usd_per_1k=0.00087,
        supports_streaming=True,
    ),
    ModelCatalogEntry(
        provider="qwen",
    ...
    # ── OpenRouter: Muse Spark 1.3 (Meta multimodal reasoning, 1M ctx) ──
    ModelCatalogEntry(
        provider="openrouter",
        model_id="meta/muse-spark-1.3",
        display_name="Muse Spark 1.3 (via OpenRouter)",
        context_window_tokens=1_048_576,
        input_cost_usd_per_1k=0.00125,
        output_cost_usd_per_1k=0.00425,
        supports_streaming=True,
        supports_vision=True,
    ),
    ModelCatalogEntry(
        ...
        display_name="Muse Spark 1.3 Contributor (via OpenRouter)",
        context_window_tokens=1_048_576,
        input_cost_usd_per_1k=0.0001,
        output_cost_usd_per_1k=0.0002,
        supports_streaming=True,
