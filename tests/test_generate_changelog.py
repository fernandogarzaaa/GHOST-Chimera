...
from scripts.generate_changelog import (  # noqa: E402
...
class TestChangelogFormatting:
    ...
    def test_format_markdown_empty(self):
        ...
        changelog = {"Features": [], "Fixes": [], "Tests": [], "Docs": [], "Chores": [], "Other": []}
    ...
    def test_format_markdown_with_commits(self):
        ...
        changelog = {
            ...
            "Fixes": [{"sha": "ghi9012", "subject": "fix: bug fix"}],
            "Tests": [],
            "Docs": [],
            "Chores": [],
            "Other": [],
    ...
    def test_format_json_with_commits(self):
        ...
        changelog = {
            "Features": [{"sha": "abc1234", "subject": "feat: add feature"}],
            "Fixes": [],
            "Tests": [],
            "Docs": [],
            "Chores": [],
...
class TestChangelogCLI:
    ...
    def test_cli_runs_without_error(self, mock_git_log):
        ...
        mock_git_log.return_value = ["abc1234 feat: test feature"]
